	...
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			SE: map[string]config.SEEntry{
				"chime": {File: "/assets/chime.wav", Volume: 0.8, Overlay: testutil.Ptr(true)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
...
func TestBuildFFmpegArgs_SEAfterPause_HasShiftedOffset(t *testing.T) {
	...
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			SE: map[string]config.SEEntry{
				"chime": {File: "/assets/chime.wav", Volume: 1.0, Overlay: testutil.Ptr(true)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
	...
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			SE: map[string]config.SEEntry{
				...
				"overlay_se": {File: "/assets/overlay.wav", Volume: 1.0, Overlay: testutil.Ptr(true)},
			},
		},
...
func TestBuildSEOverlay_OneOverlayEvent(t *testing.T) {
	...
	assets := config.AssetsConfig{
		SE: map[string]config.SEEntry{
			"chime": {File: "/chime.wav", Volume: 0.8, Overlay: testutil.Ptr(true)},
		},
	}
...
func TestBuildFFmpegArgs_BGMFadeInOut_A1(t *testing.T) {
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			BGM: map[string]config.BGMEntry{
				"talk_bgm": {File: "/assets/bgm.mp3", Volume: 0.3, Loop: true, FadeIn: testutil.Ptr(0.5), FadeOut: testutil.Ptr(0.5)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
...
func TestBuildFFmpegArgs_BGMFadeDisabled_A5(t *testing.T) {
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			BGM: map[string]config.BGMEntry{
				"talk_bgm": {File: "/assets/bgm.mp3", Volume: 0.3, Loop: true, FadeIn: testutil.Ptr(0.0), FadeOut: testutil.Ptr(0.0)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
...
func TestBuildFFmpegArgs_BGMCrossfade_A2(t *testing.T) {
	...
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			BGM: map[string]config.BGMEntry{
				"bgm_a": {File: "/assets/bgm_a.mp3", Volume: 0.3, Loop: true, FadeIn: testutil.Ptr(0.5), FadeOut: testutil.Ptr(1.0)},
				"bgm_b": {File: "/assets/bgm_b.mp3", Volume: 0.3, Loop: true, FadeIn: testutil.Ptr(1.0), FadeOut: testutil.Ptr(0.5)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
	...
	ctx := BuildContext{
		...
		Assets: config.AssetsConfig{
			BGM: map[string]config.BGMEntry{
				...
				"talk_bgm": {File: "/assets/bgm.mp3", Volume: 0.3, Loop: true, FadeIn: testutil.Ptr(1.0), FadeOut: testutil.Ptr(1.0)},
			},
		},
		PauseSec: 0.5,
		OutPath:  "/out.mp3",
