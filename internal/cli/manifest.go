...
例:
  vox-radio episodegen manifest --spec sample/episode-spec.yaml --audio output/episode.mp3 --out output/manifest.json
  vox-radio episodegen manifest --spec sample/episode-spec.yaml --rundown output/intermediate/02_rundown.json --audio output/episode.mp3 --out output/manifest.json
  vox-radio episodegen manifest --spec sample/episode-spec.yaml --lines output/intermediate/03_lines.json --audio output/episode.mp3 --out output/manifest.json`,
