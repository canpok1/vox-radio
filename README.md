...
vox-radio は、好きなテーマやキャラクターで**自分だけのラジオ番組**を手軽に作れるツールです。ずんだもんとめたんがその魅力を紹介するサンプル番組を公開しています。

[デモ番組を聴く](https://github.com/canpok1/vox-radio/releases/tag/demo)

作った番組は世界に公開することもできますが、その場合は利用する素材の利用規約に注意が必要です（[ライセンス・免責事項](#ライセンス免責事項)）。
